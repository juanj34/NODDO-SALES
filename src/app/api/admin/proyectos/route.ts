...
export async function GET() {
  ...
  const { data: projects, error } = await admin
    .from("proyectos")
    .select("id, nombre, slug, subdomain, estado, plan, user_id, render_principal_url, constructora_nombre, created_at, storage_tours_bytes, storage_videos_bytes, storage_media_bytes, storage_limit_bytes")
