  ...
  return (
    <div className="h-screen w-full relative overflow-hidden flex">
      ...
      <div className="flex-1 relative">
        ...
        <motion.div
          className="absolute top-6 left-6 z-10 glass rounded-full p-1 flex items-center gap-1"
        ...
        <motion.div
          className="absolute bottom-6 left-6 z-10 glass rounded-2xl p-4 max-w-xs"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <AnimatePresence>
        {showMapaImagen && mapa_ubicacion_url && (
          ...
          >
            ...
            <button
              onClick={() => setShowMapaImagen(false)}
              className="absolute top-6 right-6 z-10 w-10 h-10 glass rounded-full flex items-center justify-center text-[var(--text-secondary)] hover:text-white transition-colors cursor-pointer"
            >
              <X size={20} />
            </button>
