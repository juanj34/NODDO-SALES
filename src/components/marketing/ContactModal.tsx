      ...
      {isContactOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-lg flex flex-col sm:rounded-2xl overflow-hidden overflow-y-auto border-0 sm:border border-[rgba(var(--mk-accent-rgb),0.2)] shadow-[0_0_60px_rgba(var(--mk-accent-rgb),0.1)] bg-[var(--mk-bg)]"
