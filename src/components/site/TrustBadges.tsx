...
export const trustBadgePresets = {
  contactForm: (t: (key: string) => string): TrustBadge[] => [
    {
      icon: Shield,
      text: t("trustBadges.dataEncrypted"),
      variant: "security",
    },
    {
      icon: Clock,
      text: t("trustBadges.fastResponse"),
      subtext: t("trustBadges.guaranteed"),
      variant: "speed",
    },
    {
      icon: Users,
      text: t("trustBadges.familiesTrust"),
      variant: "social",
    },
    {
      icon: Award,
  ...
  cotizador: (t: (key: string) => string): TrustBadge[] => [
    {
      icon: Shield,
      text: t("trustBadges.noCommitment"),
      variant: "security",
    },
    {
      icon: Clock,
      text: t("trustBadges.freePDF"),
      subtext: t("trustBadges.fiveMin"),
      variant: "speed",
    },
    {
      icon: Award,
      text: t("trustBadges.flexiblePlans"),
      variant: "guarantee",
    },
  ],
  leadOnly: (t: (key: string) => string): TrustBadge[] => [
    ...
    {
      icon: FileText,
      text: t("trustBadges.personalizedQuote"),
      subtext: t("trustBadges.byAdvisor"),
      variant: "guarantee",
    },
  ],
};
